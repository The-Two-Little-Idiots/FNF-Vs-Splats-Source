...
class PlayState extends MusicBeatState
{
	...
	public var defaultCamZoom:Float = 0.55;
	...
	function endSong():Void
	{
		...
		if(achievementObj != null) {
			...
			var achieve:Int = checkForAchievement([1, 2, 3, 4, 5, 6, 7, 8, 9, 12, 13, 14, 15, 16]);
			if(achieve > -1) {
	...
	override function beatHit()
	{
		...
		switch (curStage)
		{
			...
			case 'splat':
				...
				if(heyTimer <= 0) stand.dance(true);
			case 'mall':
				if(!ClientPrefs.lowQuality) {
					upperBoppers.dance(true);
				}
