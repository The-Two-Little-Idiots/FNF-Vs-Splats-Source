...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		['Creaters of this Mod'],
		['Cyan',                'cyan',             'The Only Programer In This Mod (he sucks at it)',                   'https://www.youtube.com/channel/UCNLwDlOnDGYJk-C54bj7A6A',    0xFF00FFFF],
		['Spray',               'spray',            'The Artist In The Mod (and creator of splats)',				'https://www.youtube.com/channel/UCFDwAAVWwEb5zdMgK63HqpA',    0xFF6475F3],
		[''],
		['Psych Engine Team'],
